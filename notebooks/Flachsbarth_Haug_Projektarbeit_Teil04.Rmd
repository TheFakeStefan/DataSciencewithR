...
ggplot(ostwahl, aes(x=Wahljahr, y=value, color=variable)) +
  ...
  theme_classic() +
  expand_limits(y=0) +
  labs(title="Wahlergebnisse in Ostdeutschland 1990 - 2017", x="Wahljahr", y="Anteil Zweitstimmen") +
  theme(text = element_text(size=12),
        plot.background = element_rect(fill = "#FAFAFA"),
        panel.grid.major = element_blank(),
        panel.grid.minor = element_blank(),
...
ggplot(verfeinkommen_all, aes(x=Year, y=Verf_Einkommen, color=OstWest)) +
  geom_line() +
  theme_classic() +
  labs(title="Verfügbare Einkommen in EUR (Ost/West)", subtitle="Zeitraum 2002 - 2016", x="", y="")
